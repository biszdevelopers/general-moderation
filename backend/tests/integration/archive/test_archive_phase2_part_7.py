...
class TestMultiAppArchive(BaseTest):
    ...
    @pytest.mark.parametrize(
        ...
        _MULTI_APP_ARCHIVE_CASES,
    )
    def test_multi_app_archive(
        self, app_count: int, pattern: int, expected_summary: int, uid: int
    ) -> None:
        """Each app archives independently for the shared user."""
...
class TestMixedArchive(BaseTest):
    ...
    @pytest.mark.parametrize(
        ...
        _MIXED_ARCHIVE_CASES,
    )
    def test_mixed_archive(
        self,
        volume: int,
        flagged: int,
        blocked: int,

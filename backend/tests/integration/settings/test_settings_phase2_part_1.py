...
_DESCRIBE_FIELD_CASES: tuple[tuple[str, str, int], ...] = (
    ...
    ('CUSTOM_WORDS_PATH', 'key', 5411,),
    ('CUSTOM_WORDS_PATH', 'value', 5412,),
    ('CUSTOM_WORDS_PATH', 'type', 5413,),
    ('CUSTOM_WORDS_PATH', 'editable', 5414,),
    ('CUSTOM_WORDS_STORAGE', 'key', 5415,),
    ('CUSTOM_WORDS_STORAGE', 'value', 5416,),
    ('CUSTOM_WORDS_STORAGE', 'type', 5417,),
    ('CUSTOM_WORDS_STORAGE', 'editable', 5418,),
    ('DETECTOR_THREAD_POOL_SIZE', 'key', 5419,),
    ('DETECTOR_THREAD_POOL_SIZE', 'value', 5420,),
    ('DETECTOR_THREAD_POOL_SIZE', 'type', 5421,),
    ('DETECTOR_THREAD_POOL_SIZE', 'editable', 5422,),
    ('ENABLE_BADWORDS_PY', 'key', 5423,),
    ('ENABLE_BADWORDS_PY', 'value', 5424,),
    ('ENABLE_BADWORDS_PY', 'type', 5425,),
    ('ENABLE_BADWORDS_PY', 'editable', 5426,),
    ('ENABLE_GANGAJAL', 'key', 5427,),
    ('ENABLE_GANGAJAL', 'value', 5428,),
    ('ENABLE_GANGAJAL', 'type', 5429,),
    ('ENABLE_GANGAJAL', 'editable', 5430,),
    ('ENABLE_GLIN_PROFANITY', 'key', 5431,),
    ('ENABLE_GLIN_PROFANITY', 'value', 5432,),
    ('ENABLE_GLIN_PROFANITY', 'type', 5433,),
    ('ENABLE_GLIN_PROFANITY', 'editable', 5434,),
    ('ENABLE_PROFANITE', 'key', 5435,),
    ('ENABLE_PROFANITE', 'value', 5436,),
    ('ENABLE_PROFANITE', 'type', 5437,),
    ('ENABLE_PROFANITE', 'editable', 5438,),
    ('ENABLE_PROFANITY_FILTER', 'key', 5439,),
    ('ENABLE_PROFANITY_FILTER', 'value', 5440,),
    ('ENABLE_PROFANITY_FILTER', 'type', 5441,),
    ('ENABLE_PROFANITY_FILTER', 'editable', 5442,),
    ('ENABLE_PYPROFANE', 'key', 5443,),
    ('ENABLE_PYPROFANE', 'value', 5444,),
    ('ENABLE_PYPROFANE', 'type', 5445,),
    ('ENABLE_PYPROFANE', 'editable', 5446,),
    ('ENABLE_SAFETEXT', 'key', 5447,),
    ('ENABLE_SAFETEXT', 'value', 5448,),
    ('ENABLE_SAFETEXT', 'type', 5449,),
    ('ENABLE_SAFETEXT', 'editable', 5450,),
    ('ENABLE_SENSITIVE_STOP_WORDS', 'key', 5451,),
    ('ENABLE_SENSITIVE_STOP_WORDS', 'value', 5452,),
    ('ENABLE_SENSITIVE_STOP_WORDS', 'type', 5453,),
    ('ENABLE_SENSITIVE_STOP_WORDS', 'editable', 5454,),
    ('ENABLE_SENSITIVE_WORD_FILTER_CN', 'key', 5455,),
    ('ENABLE_SENSITIVE_WORD_FILTER_CN', 'value', 5456,),
    ('ENABLE_SENSITIVE_WORD_FILTER_CN', 'type', 5457,),
    ('ENABLE_SENSITIVE_WORD_FILTER_CN', 'editable', 5458,),
    ('ENCRYPTION_KEY', 'key', 5459,),
    ('ENCRYPTION_KEY', 'value', 5460,),
    ('ENCRYPTION_KEY', 'type', 5461,),
    ('ENCRYPTION_KEY', 'editable', 5462,),
)

...
## Phase 2 Coverage (Current) - 2,600 cases
| Submodule | Cases | Files |
| :--- | :--- | :--- |
| Archive | 950 | test_archive_phase2_part_1 .. 10 |
| Auto-Tuning | 550 | test_auto_tuning_phase2_part_1 .. 6 |
| Model/LLM | 550 | test_model_phase2_part_1 .. 6 |
| Settings | 550 | test_settings_phase2_part_1 .. 6 |

Plus the export service (`tests/export/`, 600 cases,
`test_export_phase2_part_1 .. 6`) and security (`tests/security/`, 700 cases,
`test_security_phase2_part_1 .. 7`). Phase 2 cases are golden-master
characterization tests generated by `tests/tools/phase2_generator.py`.

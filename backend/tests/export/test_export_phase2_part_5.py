...
_RETENTION_CASES: tuple[tuple[int, int, str, int], ...] = (
    ...
    (1, 1, 'stale8.zip', 8340,),
    (1, 1, 'stale9.zip', 8341,),
    (90, 89, 'stale0.zip', 8342,),
    (90, 89, 'stale1.zip', 8343,),
    (90, 89, 'stale2.zip', 8344,),
    (90, 89, 'stale3.zip', 8345,),
    (90, 89, 'stale4.zip', 8346,),
    (90, 89, 'stale5.zip', 8347,),
    (90, 89, 'stale6.zip', 8348,),
    (90, 89, 'stale7.zip', 8349,),
    (90, 89, 'stale8.zip', 8350,),
    (90, 89, 'stale9.zip', 8351,),
    (90, 91, 'stale0.zip', 8352,),
    (90, 91, 'stale1.zip', 8353,),
    (90, 91, 'stale2.zip', 8354,),
    (90, 91, 'stale3.zip', 8355,),
    (90, 91, 'stale4.zip', 8356,),
    (90, 91, 'stale5.zip', 8357,),
    (90, 91, 'stale6.zip', 8358,),
    (90, 91, 'stale7.zip', 8359,),
    (90, 91, 'stale8.zip', 8360,),
    (90, 91, 'stale9.zip', 8361,),
    (365, 364, 'stale0.zip', 8362,),
    (365, 364, 'stale1.zip', 8363,),
    (365, 364, 'stale2.zip', 8364,),
    (365, 364, 'stale3.zip', 8365,),
    (365, 364, 'stale4.zip', 8366,),
    (365, 364, 'stale5.zip', 8367,),
    (365, 364, 'stale6.zip', 8368,),
    (365, 364, 'stale7.zip', 8369,),
    (365, 364, 'stale8.zip', 8370,),
    (365, 364, 'stale9.zip', 8371,),
    (365, 366, 'stale0.zip', 8372,),
    (365, 366, 'stale1.zip', 8373,),
    (365, 366, 'stale2.zip', 8374,),
    (365, 366, 'stale3.zip', 8375,),
    (365, 366, 'stale4.zip', 8376,),
    (365, 366, 'stale5.zip', 8377,),
    (365, 366, 'stale6.zip', 8378,),
    (365, 366, 'stale7.zip', 8379,),
    (365, 366, 'stale8.zip', 8380,),
    (365, 366, 'stale9.zip', 8381,),
)

...
_EDGE_EXPORT_CASES: tuple[tuple[str, int], ...] = (
    ...
    (
        "data+semantic+example",
        8503,
    ),
    (
        "logs+semantic+example",
        8504,
    ),
    (
        "data+logs+semantic+example",
        8505,
    ),
    (
        "env+example",
    ...
    (
        "data+logs+env+example",
        8509,
    ),
    (
        "semantic+env+example",
        8510,
    ),
    (
        "data+semantic+env+example",
        8511,
    ),
    (
        "logs+semantic+env+example",
        8512,
    ),
    (
        "data+logs+semantic+env+example",
        8513,
    ),
    (
        "",

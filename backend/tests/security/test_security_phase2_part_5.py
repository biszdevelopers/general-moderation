...
_INJECTION_SAFE_CASES: tuple[tuple[str, int], ...] = (
    ...
    (
        "REPLACE%20INTO%20words%20VALUES%20%281%2C%20%27x%27%29",
        8991,
    ),
    (
        "REPLACE INTO words VALUES (1, 'x')",
    ...
    (
        "new%20Function%28%27alert%281%29%27%29%28%29",
        9003,
    ),
    (
        "new Function('alert(1)')()",
    ...
    (
        "%7B%25%20raw%20%25%7D%7B%25%20endraw%20%25%7D",
        9007,
    ),
    (
        "{% raw %}{% endraw %}",
    ...
    (
        "%3B%20sh%20-c%20%27rm%20-rf%20/%27",
        9023,
    ),
    (
        "; sh -c 'rm -rf /'",

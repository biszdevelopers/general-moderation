...
_SAFETEXT_GUARD_CASES: tuple[tuple[str, str, bool, int], ...] = (
    ...
    (
        "ru",
        "обычное безобидное предложение 0",
        False,
        874,
    ),
    (
    ...
    (
        "de",
        "ein völlig harmloser satz 0",
        False,
        876,
    ),
    (
        "fr",
        "une phrase tout à fait banale 0",
        False,
        877,
    ),
    (
        "it",
        "una frase assolutamente innocua 0",
        False,
        878,
    ),
    (
        "hi",
        "यह एक साधारण वाक्य है 0",
        False,
        879,
    ),
    (
        "tr",
        "bu zararsız bir cümle 0",
        False,
        880,
    ),
    (
        "en",
        "some harmless sentence here 1",
        False,
        881,
    ),
    (
    ...
    (
        "ru",
        "обычное безобидное предложение 1",
        False,
        884,
    ),
    (
    ...
    (
        "de",
        "ein völlig harmloser satz 1",
        False,
        886,
    ),
    (
        "fr",
        "une phrase tout à fait banale 1",
        False,
        887,
    ),
    (
        "it",
        "una frase assolutamente innocua 1",
        False,
        888,
    ),
    (
        "hi",
        "यह एक साधारण वाक्य है 1",
        False,
        889,
    ),
    (
        "tr",
        "bu zararsız bir cümle 1",
        False,
        890,
    ),
    (
        "en",
        "some harmless sentence here 2",
        False,
        891,
    ),
    (
    ...
    (
        "ru",
        "обычное безобидное предложение 2",
        False,
        894,
    ),
    (
    ...
    (
        "de",
        "ein völlig harmloser satz 2",
        False,
        896,
    ),
    (
        "fr",
        "une phrase tout à fait banale 2",
        False,
        897,
    ),
    (
        "it",
        "una frase assolutamente innocua 2",
        False,
        898,
    ),
    (
        "hi",
        "यह एक साधारण वाक्य है 2",
        False,
        899,
    ),
    (
        "tr",
        "bu zararsız bir cümle 2",
        False,
        900,
    ),
)

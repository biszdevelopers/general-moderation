...
class TestThresholdSweep(BaseTest):
    ...
    @pytest.mark.parametrize(
        ...
        _THRESHOLD_SWEEP_CASES,
    )
    def test_threshold_sweep(
        self, engine: Any, similarity: float, threshold: float, category: str, uid: int
    ) -> None:
        """Similarity contributes weight only above the threshold."""
...
_QUERY_CATEGORY_MATRIX_CASES: tuple[tuple[str, int], ...] = (
    ...
    (
        "the government is corruptthe government is corruptthe government is corrupt",
        2085,
    ),
    (
        "the government is corruptthe government is corruptthe government is corrupt",
    ...
    (
        "i will kill you tonighti ",
        2092,
    ),
    (
        "i will kill you tonighti will kill you tonighti will kill you tonight",
        2093,
    ),
    (
        "i will kill you tonighti will kill you tonighti will kill you tonight",

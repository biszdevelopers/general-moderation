...
_MULTIWORD_VERDICT_CASES: tuple[tuple[str, str, str, int, str, int, int], ...] = (
    (
        "watch out for zaphrin and blorp today",
        "zaphrin",
        "blorp",
        10,
        "REVIEW",
    ...
    (
        "watch out for flubber and quxxle today",
        "flubber",
        "quxxle",
        10,
        "REVIEW",
    ...
    (
        "watch out for wombat and giblet today",
        "wombat",
        "giblet",
        10,
        "REVIEW",
    ...
    (
        "watch out for snarg and zorp today",
        "snarg",
        "zorp",
        10,
        "REVIEW",
    ...
    (
        "watch out for meldrup and vexil today",
        "meldrup",
        "vexil",
        10,
        "REVIEW",
    ...
    (
        "watch out for gromble and spritz today",
        "gromble",
        "spritz",
        10,
        "REVIEW",

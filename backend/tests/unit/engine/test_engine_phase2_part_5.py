...
_VARIED_CONTENT_MATRIX_CASES: tuple[tuple[str, str, int, int], ...] = (
    ...
    ('your ', 'PASS', 1, 1632,),
    ('your location data is bei', 'PASS', 1, 1633,),
    ('your location data is being collected quietly ', 'PASS', 1, 1634,),
    ('your location data is being collected quietly ', 'PASS', 1, 1635,),
    ('unsub', 'PASS', 1, 1636,),
    ...
    ('watch', 'PASS', 1, 1640,),
    ('watch the video of the ho', 'PASS', 1, 1641,),
...
_MULTIWORD_VERDICT_CASES: tuple[tuple[str, str, str, int, str, int, int], ...] = (
    ('watch out for zaphrin and blorp today', 'zaphrin', 'blorp', 10, 'BLOCK', 2, 1660,),
    ('watch out for zaphrin and blorp today', 'zaphrin', 'blorp', 30, 'BLOCK', 2, 1661,),
    ('watch out for zaphrin and blorp today', 'zaphrin', 'blorp', 50, 'BLOCK', 2, 1662,),
    ...
    ('watch out for flubber and quxxle today', 'flubber', 'quxxle', 10, 'BLOCK', 2, 1666,),
    ('watch out for flubber and quxxle today', 'flubber', 'quxxle', 30, 'BLOCK', 2, 1667,),
    ('watch out for flubber and quxxle today', 'flubber', 'quxxle', 50, 'BLOCK', 2, 1668,),
    ...
    ('watch out for wombat and giblet today', 'wombat', 'giblet', 10, 'BLOCK', 2, 1672,),
    ('watch out for wombat and giblet today', 'wombat', 'giblet', 30, 'BLOCK', 2, 1673,),
    ('watch out for wombat and giblet today', 'wombat', 'giblet', 50, 'BLOCK', 2, 1674,),
    ...
    ('watch out for snarg and zorp today', 'snarg', 'zorp', 10, 'BLOCK', 2, 1678,),
    ('watch out for snarg and zorp today', 'snarg', 'zorp', 30, 'BLOCK', 2, 1679,),
    ('watch out for snarg and zorp today', 'snarg', 'zorp', 50, 'BLOCK', 2, 1680,),
    ...
    ('watch out for meldrup and vexil today', 'meldrup', 'vexil', 10, 'BLOCK', 2, 1684,),
    ('watch out for meldrup and vexil today', 'meldrup', 'vexil', 30, 'BLOCK', 2, 1685,),
    ('watch out for meldrup and vexil today', 'meldrup', 'vexil', 50, 'BLOCK', 2, 1686,),
    ...
    ('watch out for gromble and spritz today', 'gromble', 'spritz', 10, 'BLOCK', 2, 1690,),
    ('watch out for gromble and spritz today', 'gromble', 'spritz', 30, 'BLOCK', 2, 1691,),
    ('watch out for gromble and spritz today', 'gromble', 'spritz', 50, 'BLOCK', 2, 1692,),
    ...
    ('watch out for krazor and tundel today', 'krazor', 'tundel', 10, 'BLOCK', 2, 1696,),
    ('watch out for krazor and tundel today', 'krazor', 'tundel', 30, 'BLOCK', 2, 1697,),
    ('watch out for krazor and tundel today', 'krazor', 'tundel', 50, 'BLOCK', 2, 1698,),

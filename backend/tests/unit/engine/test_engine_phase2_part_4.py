...
class TestMetricsCounter(BaseTest):
    ...
    @pytest.mark.parametrize(('n_moderations', 'uid',), _METRICS_COUNTER_CASES)
...
_VARIED_CONTENT_MATRIX_CASES: tuple[tuple[str, str, int, int], ...] = (
    ('you a', 'PASS', 1, 1560,),
    ('you are a piece of garbag', 'PASS', 1, 1561,),
    ('you are a piece of garbage and a loser ', 'BLOCK', 1, 1562,),
    ('you are a piece of garbage and a loser ', 'BLOCK', 1, 1563,),
    ('buy c', 'PASS', 1, 1564,),
    ('buy cheap pills online no', 'PASS', 1, 1565,),
    ('buy cheap pills online now at low prices ', 'PASS', 1, 1566,),
    ('buy cheap pills online now at low prices ', 'PASS', 1, 1567,),
    ('i wil', 'PASS', 1, 1568,),
    ('i will smash your car and', 'PASS', 1, 1569,),
    ('i will smash your car and burn the house ', 'PASS', 1, 1570,),
    ('i will smash your car and burn the house ', 'PASS', 1, 1571,),
    ('your ', 'PASS', 1, 1572,),
    ('your phone number 5551234', 'PASS', 1, 1573,),
    ('your phone number 5551234567 is now public ', 'PASS', 1, 1574,),
    ('your phone number 5551234567 is now public ', 'PASS', 1, 1575,),
    ('fuck ', 'BLOCK', 1, 1576,),
    ('fuck this noise and every', 'BLOCK', 1, 1577,),
    ('fuck this noise and everything else ', 'BLOCK', 1, 1578,),
    ('fuck this noise and everything else ', 'BLOCK', 1, 1579,),
    ('the m', 'PASS', 1, 1580,),
    ('the meeting is scheduled ', 'PASS', 1, 1581,),
    ('the meeting is scheduled for ten in the morning ', 'PASS', 1, 1582,),
    ('the meeting is scheduled for ten in the morning ', 'PASS', 1, 1583,),
    ('let u', 'PASS', 1, 1584,),
    ('let us review the quarter', 'PASS', 1, 1585,),
    ('let us review the quarterly numbers together ', 'PASS', 1, 1586,),
    ('let us review the quarterly numbers together ', 'PASS', 1, 1587,),
    ('pleas', 'PASS', 1, 1588,),
    ('please confirm the order ', 'PASS', 1, 1589,),
    ('please confirm the order number before shipping ', 'PASS', 1, 1590,),
    ('please confirm the order number before shipping ', 'PASS', 1, 1591,),
    ('your ', 'PASS', 1, 1592,),
    ('your account password was', 'BLOCK', 1, 1593,),
    ('your account password was exposed in a breach ', 'BLOCK', 1, 1594,),
    ('your account password was exposed in a breach ', 'BLOCK', 1, 1595,),
    ('join ', 'PASS', 1, 1596,),
    ('join our crypto pyramid s', 'PASS', 1, 1597,),
    ('join our crypto pyramid scheme today ', 'BLOCK', 1, 1598,),
    ('join our crypto pyramid scheme today ', 'BLOCK', 1, 1599,),
    ('this ', 'PASS', 1, 1600,),
)

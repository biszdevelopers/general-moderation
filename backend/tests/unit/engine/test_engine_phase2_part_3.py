...
class TestScorerSum(BaseTest):
    ...
    def test_scorer_sum(
        self, engine: ModerationEngine, names: tuple[object, ...], uid: int
    ) -> None:
        """Multiple detector hits sum their configured weights."""
        scorer: SuspicionScorer = SuspicionScorer(engine._settings_service)
...
_SAFE_FILTER_CASES: tuple[
    tuple[tuple[object, ...], tuple[object, ...], str, bool, str, bool, int], ...
] = (
    (
        ("alpha",),
        (),

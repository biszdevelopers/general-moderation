...
_VERDICT_EXACT_MATRIX_CASES: tuple[tuple[str, str, int, str, int, int], ...] = (
    ('you are a zaphrin here', 'zaphrin', 0, 'REVIEW', 2, 1301,),
    ('you are a zaphrin here', 'zaphrin', 10, 'REVIEW', 2, 1303,),
    ('you are a zaphrin here', 'zaphrin', 30, 'REVIEW', 2, 1305,),
    ('you are a zaphrin here', 'zaphrin', 50, 'REVIEW', 2, 1307,),
    ('you are a zaphrin here', 'zaphrin', 70, 'BLOCK', 1, 1309,),
    ('you are a zaphrin here', 'zaphrin', 100, 'BLOCK', 1, 1311,),
    ('you are a blorp here', 'blorp', 0, 'REVIEW', 2, 1313,),
    ('you are a blorp here', 'blorp', 10, 'REVIEW', 2, 1315,),
    ('you are a blorp here', 'blorp', 30, 'REVIEW', 2, 1317,),
    ('you are a blorp here', 'blorp', 50, 'REVIEW', 2, 1319,),
    ('you are a blorp here', 'blorp', 70, 'BLOCK', 1, 1321,),
    ('you are a blorp here', 'blorp', 100, 'BLOCK', 1, 1323,),
    ('you are a flubber here', 'flubber', 0, 'REVIEW', 2, 1325,),
    ('you are a flubber here', 'flubber', 10, 'REVIEW', 2, 1327,),
    ('you are a flubber here', 'flubber', 30, 'REVIEW', 2, 1329,),
    ('you are a flubber here', 'flubber', 50, 'REVIEW', 2, 1331,),
    ('you are a flubber here', 'flubber', 70, 'BLOCK', 1, 1333,),
    ('you are a flubber here', 'flubber', 100, 'BLOCK', 1, 1335,),
    ('you are a quxxle here', 'quxxle', 0, 'REVIEW', 2, 1337,),
    ('you are a quxxle here', 'quxxle', 10, 'REVIEW', 2, 1339,),
    ('you are a quxxle here', 'quxxle', 30, 'REVIEW', 2, 1341,),
    ('you are a quxxle here', 'quxxle', 50, 'REVIEW', 2, 1343,),
    ('you are a quxxle here', 'quxxle', 70, 'BLOCK', 1, 1345,),
    ('you are a quxxle here', 'quxxle', 100, 'BLOCK', 1, 1347,),
    ('you are a wombat here', 'wombat', 0, 'REVIEW', 2, 1349,),
    ('you are a wombat here', 'wombat', 10, 'REVIEW', 2, 1351,),
    ('you are a wombat here', 'wombat', 30, 'REVIEW', 2, 1353,),
    ('you are a wombat here', 'wombat', 50, 'REVIEW', 2, 1355,),
    ('you are a wombat here', 'wombat', 70, 'BLOCK', 1, 1357,),
    ('you are a wombat here', 'wombat', 100, 'BLOCK', 1, 1359,),
    ('you are a giblet here', 'giblet', 0, 'REVIEW', 2, 1361,),
    ('you are a giblet here', 'giblet', 10, 'REVIEW', 2, 1363,),
    ('you are a giblet here', 'giblet', 30, 'REVIEW', 2, 1365,),
    ('you are a giblet here', 'giblet', 50, 'REVIEW', 2, 1367,),
    ('you are a giblet here', 'giblet', 70, 'BLOCK', 1, 1369,),
    ('you are a giblet here', 'giblet', 100, 'BLOCK', 1, 1371,),
    ('you are a snarg here', 'snarg', 0, 'REVIEW', 2, 1373,),
    ('you are a snarg here', 'snarg', 10, 'REVIEW', 2, 1375,),
    ('you are a snarg here', 'snarg', 30, 'REVIEW', 2, 1377,),
    ('you are a snarg here', 'snarg', 50, 'REVIEW', 2, 1379,),
    ('you are a snarg here', 'snarg', 70, 'BLOCK', 1, 1381,),
    ('you are a snarg here', 'snarg', 100, 'BLOCK', 1, 1383,),
    ('you are a zorp here', 'zorp', 0, 'REVIEW', 2, 1385,),
    ('you are a zorp here', 'zorp', 10, 'REVIEW', 2, 1387,),
    ('you are a zorp here', 'zorp', 30, 'REVIEW', 2, 1389,),
    ('you are a zorp here', 'zorp', 50, 'REVIEW', 2, 1391,),
...
_VERDICT_TYPO_MATRIX_CASES: tuple[tuple[str, str, int, str, int, int], ...] = (
    ...
    ('you are a zaphri here', 'zaphrin', 30, 'REVIEW', 2, 1306,),
    ...
    ('you are a blor here', 'blorp', 30, 'REVIEW', 2, 1318,),
    ...
    ('you are a flubbe here', 'flubber', 30, 'REVIEW', 2, 1330,),
    ...
    ('you are a quxxl here', 'quxxle', 30, 'REVIEW', 2, 1342,),
    ...
    ('you are a womba here', 'wombat', 30, 'REVIEW', 2, 1354,),
    ...
    ('you are a gible here', 'giblet', 30, 'REVIEW', 2, 1366,),
    ...
    ('you are a snar here', 'snarg', 30, 'REVIEW', 2, 1378,),
    ...
    ('you are a zor here', 'zorp', 30, 'REVIEW', 2, 1390,),

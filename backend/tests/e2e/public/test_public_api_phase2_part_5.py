...
_EDGE_CONTENT_CASES: tuple[tuple[str, int], ...] = (
    ...
    (
        "emoji 😀 test emoji 😀 test emoji 😀 test",
        6919,
    ),
    (
        "lead emoji 😀 test",
    ...
    (
        "mixed 中文 english 123 mixed 中文 english 123",
        6933,
    ),
    (
        "mixed 中文 english 123 mixed 中文 english 123 mixed 中文 english 123",
        6934,
    ),
    (
        "lead mixed 中文 english 123",
        6935,
    ),
    (
        "mixed 中文 english 123 tail",
        6936,
    ),
    (
        "tab\tseparated",
    ...
    (
        "tab\tseparated tab\tseparated tab\tseparated",
        6939,
    ),
    (
        "lead tab\tseparated",
    ...
    (
        "lead multiple   spaces",
        6950,
    ),
    (
        "multiple   spaces tail",
        6951,
    ),
    (
        "!!! ??? ...",
    ...
    (
        "zero width \u200b join zero width \u200b join zero width \u200b join",
        6979,
    ),
    (
        "lead zero width \u200b join",
        6980,
    ),
    (
    ...
    (
        "directional \u202e override directional \u202e override",
        6983,
    ),
    (
        "directional \u202e override directional \u202e override directional \u202e override",
        6984,
    ),
    (
        "lead directional \u202e override",
        6985,
    ),
    (
        "directional \u202e override tail",
        6986,
    ),
    (
        "combining é",
    ...
    (
        "combining é combining é",
        6988,
    ),
    (
        "combining é combining é combining é",
        6989,
    ),
    (
        "lead combining é",
    ...
    (
        "русский текст русский текст русский текст",
        6994,
    ),
    (
        "lead русский текст",
    ...
    (
        "العربية نص العربية نص العربية نص",
        7009,
    ),
    (
        "lead العربية نص",
    ...
    (
        "עברית טקסט עברית טקסט עברית טקסט",
        7014,
    ),
    (
        "lead עברית טקסט",
